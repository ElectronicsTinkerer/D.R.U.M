...
void serbus_read_cmd(size_t, ctlword_t, ctlword_t *);
void serbus_read_cmd_all(ctlword_t *);
void serbus_select_module(int);
inline void serbus_txrx(uint32_t *, uint32_t *, size_t);
